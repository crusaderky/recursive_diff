...
latex_documents = [
  ('index', 'recursive_diff.tex', 'recursive_diff Documentation',
   'recursive_diff Developers', 'manual'),
]
...
man_pages = [
    ('index', 'recursive_diff', 'recursive_diff Documentation',
     ['recursive_diff Developers'], 1)
]
...
texinfo_documents = [
  ('index', 'recursive_diff', 'recursive_diff Documentation',
   'recursive_diff Developers', 'recursive_diff',
