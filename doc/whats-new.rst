...
v0.3.1 (Unreleased)
-------------------
- Fixed bug in :func:`~recursive_diff.stack.proper_unstack` where unstacking
...
- New function :func:`~recursive_diff.stack.proper_unstack`
- New functions :func:`~recursive_diff.recursive_diff.recursive_diff`
  and :func:`recursive_diff.testing.recursive_eq`
...
- Fixed segmentation faults in :func:`~recursive_diff.csv.to_csv`
...
- Added parameter nogil=True to :func:`~recursive_diff.csv.to_csv`, which will
...
- New function :func:`recursive_diff.csv.to_csv`
