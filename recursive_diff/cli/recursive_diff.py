...
def main(argv: list[str] | None = None, *, ncdiff: bool = False) -> int:
    ...
    :param bool ncdiff:
        DEPRECATED. False if is the new recursive-diff tool; True if it's the
        old ncdiff. The two differ only by command-line arguments.
